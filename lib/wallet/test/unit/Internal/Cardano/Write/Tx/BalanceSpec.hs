...
prop_balanceTransactionValid
  ...
  where
    ...
    hasCollateral :: Tx era -> Bool
    hasCollateral = not . Set.null
...
dummyByronChangeAddressGen = flip AnyChangeAddressGenWithState () $
    ChangeAddressGen
        { genChangeAddress = \() -> (dummyBootAddr, ())
        , maxLengthChangeAddress = dummyBootAddr
        }
  where
    -- Hard-coded address originally derived from a Byron wallet using
    -- cardano-wallet.
    dummyBootAddr = fromJust $ deserialiseAddr $ unsafeFromHex
        "82d818584283581c34a938c9cbd3a6f18635a29a754c3fa8cf8098b0a1c46d278ece2e75a101581e581c45c79d48621a8957dc3122167e9cb2a9651dd13d0b4b7a9a4f2a408d001adb76aa8f"
