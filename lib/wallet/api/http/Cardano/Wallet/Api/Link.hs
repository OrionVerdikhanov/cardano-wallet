...
listTransactions'
  ...
  -> Maybe Address
  -> (Method, Text)
listTransactions' w minWithdrawal inf sup order limit address =
  discriminate @style
...
postPoolMaintenance = endpoint @Api.PostPoolMaintenance id

getPoolMaintenance :: (Method, Text)
getPoolMaintenance = endpoint @Api.GetPoolMaintenance id
...
postExternalTransaction = endpoint @Api.PostExternalTransaction id
...
putSettings = endpoint @Api.PutSettings id

getSettings :: (Method, Text)
getSettings = endpoint @Api.GetSettings id
